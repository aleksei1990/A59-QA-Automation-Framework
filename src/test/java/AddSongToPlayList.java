...
public class AddSongToPlayList extends BaseTest {
    ...
    public void addSongToPlayList() throws InterruptedException {
        ...
        String expectedSongAddedMessage = "Added 1 song into \"Playlist 78.\"";
        String songName = "dark";

        loginPage.login();
        homePage.enterSearchSong(songName);
        searchPage.pressViewAllButton();
        searchPage.getFirstSong();
        searchPage.pressAddToButton();
        searchPage.selectPlayList();
        Assert.assertTrue(searchPage.getAddToPlayListMessage().isDisplayed());
...
//        WebElement playlist = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//section[@id='songResultsWrapper']//li[contains(text(),'Playlist 78')]")));
